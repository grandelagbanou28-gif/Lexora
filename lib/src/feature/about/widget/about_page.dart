    ...
    return Title(
      ...
      child: Scaffold(
        backgroundColor: context.theme
            .extension<BackgroundCustomColors>()
            ?.background,
        appBar: AppBar(
          centerTitle: true,
          title: Text(
          ...
          child: Column(
            children: [
              ...
              const _CreditNameText(
                text:
                    'Lexora · Based on Wordly Plus by Roman Laptev (Carapacik)',
...
class _MailToContact extends StatelessWidget {
  const _MailToContact({required this.contact, required this.email});
