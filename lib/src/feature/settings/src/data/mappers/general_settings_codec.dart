...
class const GeneralSettingsCodec() extends JsonMapCodec<GeneralSettings> {
  @override
  GeneralSettings $decode(Map<String, Object?> input) {
    ...
    final activeTheme = input['activeTheme'] as String?;
    final hardMode = input['hardMode'] as bool?;
    ...
    return GeneralSettings(
      ...
      hardMode: hardMode ?? defaults.hardMode,
    );
  }
