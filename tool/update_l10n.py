...
STRINGS = {
    ...
    'practiceMode': ('Practice', 'Entraînement', 'Nǔxòtɔ́', 'Тренировка'),
    'friendMode': ('Friend challenge', 'Défi ami', 'Xwégbé hònnɔ̀', 'Вызов друга'),
    'hardMode': ('Hard mode', 'Mode difficile', 'Mɔdo kpɛɖé', 'Сложный режим'),
    'hardModeDesc': (
    ...
    'peekRow': ('Reveal the whole row', 'Révéler toute la rangée', 'Sɔ́ hwèkpó kpó', 'Открыть всю строку'),
    'bossBonus': ('Boss bonus', 'Bonus boss', 'Bonus gántó', 'Бонус босса'),
    'playAgain': ('Play again', 'Rejouer', 'Dà azɔ̌ ɖevo', 'Сыграть снова'),
    'cancel': ('Cancel', 'Annuler', 'Ɖónù', 'Отмена'),
    ...
    'repairStreak': ('Repair your streak', 'Réparer ta série', 'Xɔ́ sɔsɔ́ ɖɔ̀n', 'Восстановить серию'),
    'repairStreakDone': ('Streak restored!', 'Série restaurée !', 'Sɔsɔ́ ɖɔ̀n!', 'Серия восстановлена!'),
    'seasonPass': ('Weekly pass', 'Passe hebdomadaire', 'Paisse sɛ́nsɛ́n', 'Недельный абонемент'),
    'seasonPassSubtitle': (
    ...
    'seasonPassDaily': ('Day', 'Jour', 'Azǎn', 'День'),
    'seasonPassBought': ('Pass activated!', 'Passe activée !', 'Paisse ɔ hùn!', 'Абонемент активирован!'),
    'seasonPassFinished': ('Pass finished', 'Passe terminée', 'Paisse ɔ kpé', 'Абонемент завершён'),
    'seasonPassClaim': ('Claim today\u2019s reward', 'Réclamer la récompense du jour', 'Xɔ́ fɖé azǎn ɔ', 'Забрать награду дня'),
}
